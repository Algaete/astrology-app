...
import com.algaete.horoscapp.databinding.FragmentHoroscopeBinding
import com.algaete.horoscapp.domain.model.HoroscopeInfo
import com.algaete.horoscapp.domain.model.HoroscopeModel
import com.algaete.horoscapp.ui.horoscopo.adapter.HoroscopeAdapter
...
class HoroscopeFragment : Fragment() {
    ...
    private fun initUIState() {
        lifecycleScope.launch {  // siempre que necesite usar una corrutina en un fragment usar lifecyclescope que se encargara del ciclo de vida del fragment , osea si muere el fragment se encarga de matar la corrutina
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                horoscopeViewModel.horoscope.collect { // collect se refiere a engancharse al state flow por ejemplo, como suscribirse
                        //cambios en horoscope
                      x -> horoscopeAdapter.updateList(x)
