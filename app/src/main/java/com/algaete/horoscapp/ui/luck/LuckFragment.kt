package com.algaete.horoscapp.ui.luck
...
import com.algaete.horoscapp.databinding.FragmentLuckBinding
import com.algaete.horoscapp.ui.core.listeners.OnSwipeTouchListener
import com.algaete.horoscapp.ui.model.LuckyModel
import com.algaete.horoscapp.ui.providers.RandomCardProvider
...
class LuckFragment : Fragment() {
    ...
    private fun shareResult(prediction:String){
        ...
        val sahreIntent = Intent.createChooser(sendIntent, null)
        startActivity(sahreIntent)
    }
    ...
    private fun sliceCard() {
        val sliceUpAnimation = AnimationUtils.loadAnimation(requireContext(), R.anim.slide_up)
